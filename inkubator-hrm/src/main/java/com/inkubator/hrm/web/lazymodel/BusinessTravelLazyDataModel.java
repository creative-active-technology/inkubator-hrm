...
public class BusinessTravelLazyDataModel extends LazyDataModel<BusinessTravel> implements Serializable {
    ...
    @Override
    public List<BusinessTravel> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) {
        ...
        try {
	        ...
	        if (sortField != null) {
	        	...
	        	orderable = Order.desc("businessTravelNo");
	        }
