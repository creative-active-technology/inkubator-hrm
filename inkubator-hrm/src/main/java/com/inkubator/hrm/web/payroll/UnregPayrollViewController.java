...
import com.inkubator.hrm.web.lazymodel.UnregPayrollLazyDataModel;
...
* @author rizkykojek
*/
@ManagedBean(name = "unregPayrollViewController")
@ViewScoped
public class UnregPayrollViewController extends BaseController {
	...
	public LazyDataModel<UnregSalary> getLazyDataModel() {
		if(lazyDataModel == null){
			lazyDataModel = new UnregPayrollLazyDataModel(unregSalaryService, period.getFromPeriode(), parameter);
		}
	...
	public String doDetail(){
		return "/protected/payroll/unreg_payroll_detail.htm?faces-redirect=true&execution=e" + selectedModel.getId();
	}
