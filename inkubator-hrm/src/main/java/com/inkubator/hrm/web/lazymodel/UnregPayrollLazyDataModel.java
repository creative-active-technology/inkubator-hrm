...
* @author rizkykojek
*/
public class UnregPayrollLazyDataModel extends LazyDataModel<UnregSalary> implements Serializable {

	private static final Logger LOGGER = Logger.getLogger(UnregPayrollLazyDataModel.class);
    ...
    public UnregPayrollLazyDataModel(UnregSalaryService unregSalaryService, Date fromPeriodPayrollType, UnregSalarySearchParameter parameter) {
    ...
    public List<UnregSalary> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) {
        ...
        try {
	        ...
	        list = unregSalaryService.getByParamBySalaryPayroll(parameter, fromPeriodPayrollType, first, pageSize, orderable);
	        total = Integer.parseInt(String.valueOf(unregSalaryService.getTotalByParamBySalaryPayroll(parameter, fromPeriodPayrollType)));            
