 ...
 */
@ManagedBean(name = "reportEmpPosRecapitulationViewController")
@ViewScoped
public class ReportEmpPosRecapitulationViewController extends BaseController {
    ...
    private ReportRekapJabatanEmpSearchParameter searchParameter;
    ...
    public void initialization() {
        ...
        try {            
            ...
            reportDate = new Date();
            searchParameter = new ReportRekapJabatanEmpSearchParameter();
            ...
            Logger.getLogger(ReportEmpPosRecapitulationViewController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public ReportRekapJabatanEmpSearchParameter getSearchParameter() {
        return searchParameter;
    }

    public void setSearchParameter(ReportRekapJabatanEmpSearchParameter searchParameter) {
        this.searchParameter = searchParameter;
    }

    public LazyDataModel<EmpData> getLazyDataModel() {
        if (lazyDataModel == null) {          
            lazyDataModel = new ReportRekapJabatanEmpLazyDataModel(searchParameter, empDataService);
        }
