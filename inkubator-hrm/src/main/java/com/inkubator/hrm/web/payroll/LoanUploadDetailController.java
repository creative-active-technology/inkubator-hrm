 ...
 * @author rizkykojek
 */
@ManagedBean(name = "loanUploadDetailController")
@ViewScoped
public class LoanUploadDetailController extends BaseController {
	...
	public String doBack() {
        return "/protected/payroll/loan_upload_view.htm?faces-redirect=true";
    }    
