...
public class RecruitInitialLazyDataModel extends LazyDataModel<RecruitApplicant> implements Serializable{
	private static final Logger LOGGER = Logger.getLogger(RecruitInitialLazyDataModel.class);
    private final RecruitInitialSelectionSearchParameter parameter;
    private final RecruitApplicantService recruitApplicantService;
    private List<RecruitApplicant> list = new ArrayList<>();
    private Integer total;
    
    public RecruitInitialLazyDataModel(RecruitInitialSelectionSearchParameter parameter, RecruitApplicantService recruitApplicantService) {
    ...
    public List<RecruitApplicant> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) {
        ...
        try {
	        ...
	        list = recruitApplicantService.getAllDataByParamWithDetail(parameter, first, pageSize, orderable);
            total = Integer.parseInt(String.valueOf(recruitApplicantService.getTotalDataByParamWithDetail(parameter)));            
