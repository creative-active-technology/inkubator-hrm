...
@ViewScoped
public class ReportLeaveHistoryViewController extends BaseController {
    ...
    public void listReportHistory() {
        try {
            ...
            Logger.getLogger(ReportLeaveHistoryViewController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
