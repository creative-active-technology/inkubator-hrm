 ...
 * @author rizkykojek
 */
public class SelectionApplicantSchedulleDetailRealizationModel implements Serializable, Cloneable {
	...
	public Object clone() throws CloneNotSupportedException {
		SelectionApplicantSchedulleDetailRealizationModel clone = null;
		try {
			clone = (SelectionApplicantSchedulleDetailRealizationModel) super.clone();
