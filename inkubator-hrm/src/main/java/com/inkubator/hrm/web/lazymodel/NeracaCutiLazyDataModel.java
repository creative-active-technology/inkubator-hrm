...
public class NeracaCutiLazyDataModel extends LazyDataModel<NeracaCuti> implements Serializable{
    ...
    @Override
    public List<NeracaCuti> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) {
        LOGGER.info("Step Load Lazy data Model");
            ...
            try {
                ...
                neracaCutiList = service.getByParamWithDetail(searchParameter, first, pageSize, order);
