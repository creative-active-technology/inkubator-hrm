 ...
 * @author rizkykojek
 */
@FacesConverter(value = "businessTravelStatusConverter")
public class BusinessTravelStatusConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent uiComponent, Object obj) {
        ...
        if(Objects.equals(data, HRMConstant.APPROVAL_STATUS_APPROVED)){
        	...
        	messages = resourceBundle.getString("businesstravel.on_going_implemented");
        } else if(Objects.equals(data, HRMConstant.BUSINESS_TRAVEL_STATUS_DONE)){
        	messages = resourceBundle.getString("businesstravel.has_been_done_implemented");
        }
        return messages;
