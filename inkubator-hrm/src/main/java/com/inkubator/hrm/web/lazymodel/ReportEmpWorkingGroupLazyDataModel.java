...
* @author rizkykojek
*/
public class ReportEmpWorkingGroupLazyDataModel extends LazyDataModel<EmpData> implements Serializable {

	private static final Logger LOGGER = Logger.getLogger(ReportEmpWorkingGroupLazyDataModel.class);
    private final ReportEmpWorkingGroupParameter parameter;
    private final EmpDataService empDataService;
    private List<EmpData> empDatas = new ArrayList<>();
    private Integer total;

    public ReportEmpWorkingGroupLazyDataModel(ReportEmpWorkingGroupParameter parameter, EmpDataService empDataService) {
