...
public class HRMConstant {
    ...
    public static final String SAVE_CONDITION_WITH_APPROVAL = "SAVE_CONDITION_WITH_APPROVAL";
...
//    KODEFIKAISIPROSES
 ...
 /* 
    ...
    public static final String SCHEDULER_CONFIG_NAME_USER_PASSWORD_NOTIFICATION = "USER_PASSWORD_NOTIFICATION";
    public static final String SCHEDULER_CONFIG_NAME_APROVAL_MATRIX_NOTIF = "APROVAL_MATRIX_NOTIF";
    public static final String SCHEDULER_CONFIG_NAME_DELETE_ACESS_HISTORY = "DELETE_ACESS_HISTORY";
    public static final String SCHEDULER_CONFIG_NAME_DELETE_LOG_HISTORY = "DELETE_LOG_HISTORY";
    public static final String SCHEDULER_CONFIG_NAME_HOLIDAY_UPDATE = "HOLIDAY_UPDATE";
    public static final String SCHEDULER_CONFIG_NAME_SCHEDULE_WORK = "SCHEDULE_WORK";
    public static final String SCHEDULER_CONFIG_NAME_DELETE_TEMP_SCHEDULE_WORK = "DELETE_TEMP_SCHEDULE_WORK";
    public static final String SCHEDULER_CONFIG_NAME_AUTO_APPROVAL_MATRIX = "AUTO_APPROVAL_MATRIX";
    public static final String SCHEDULER_CONFIG_NAME_ADD_BALANCE_LEAVE = "ADD_BALANCE_LEAVE";
    public static final String SCHEDULER_CONFIG_NAME_ADD_BALANCE_PERMIT = "ADD_BALANCE_PERMIT";
    public static final String SCHEDULER_CONFIG_NAME_COMPANY_POLICY_SEND = "COMPANY_POLICY_SEND";
