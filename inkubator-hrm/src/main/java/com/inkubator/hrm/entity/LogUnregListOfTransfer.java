 ...
 */
@Entity
@Table(name="log_unreg_list_of_transfer", catalog="hrm_payroll_backup"
)
public class LogUnregListOfTransfer implements Serializable {
    ...
    public LogUnregListOfTransfer(){
    	
    }
    
    public LogUnregListOfTransfer(Long id){
    	this.id = id;
    }
    
    @Id
    @Column(name = "id", unique = true, nullable = false)
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "log_unreg_list_of_transfer_seq_gen")
    @SequenceGenerator(name = "log_unreg_list_of_transfer_seq_gen", sequenceName = "LOG_UNREG_LIST_OF_TRANSFER_SEQ")
    public Long getId() {
        return this.id;
    }
