 ...
 */
@Entity
@Table(name="log_unreg_payroll", catalog="hrm_payroll_backup"
)
public class LogUnregPayroll implements Serializable {
    ...
    public LogUnregPayroll(){
    	
    }
    
    public LogUnregPayroll(Long id){
    	this.id = id;
    }
    
    @Id
    @Column(name = "id", unique = true, nullable = false)
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "log_unreg_payroll_seq_gen")
    @SequenceGenerator(name = "log_unreg_payroll_seq_gen", sequenceName = "LOG_UNREG_PAYROLL_SEQ")
    public Long getId() {
        return this.id;
    }
