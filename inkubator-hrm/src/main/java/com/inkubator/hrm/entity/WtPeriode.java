...
public class WtPeriode  implements java.io.Serializable {
    ...
    public WtPeriode(long id, String tahun, String bulan, Date fromPeriode, Date untilPeriode, String absen, String payrollType, String createdBy, Date createdOn, String updatedBy, Date updatedOn) {
       this.id = id;
       this.tahun = tahun;
       this.bulan = bulan;
