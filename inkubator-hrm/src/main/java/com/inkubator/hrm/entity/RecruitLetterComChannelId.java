...
public class RecruitLetterComChannelId  implements java.io.Serializable {
    ...
    public RecruitLetterComChannelId(int commChannelId, long letterId) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof RecruitLetterComChannelId) ) return false;
 ...
 && (this.getLetterId()==castOther.getLetterId());
   ...
   public int hashCode() {
         ...
         result = 37 * result + this.getCommChannelId();
