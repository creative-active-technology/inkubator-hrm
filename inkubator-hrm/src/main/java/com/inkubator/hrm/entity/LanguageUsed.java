...
public class LanguageUsed  implements java.io.Serializable {
    ...
    public LanguageUsed(long id) {
        this.id = id;
    }
    public LanguageUsed(long id, String createdBy, Date createdOn, String updatedBy, Date updatedOn, String languageName, String description) {
       this.id = id;
    ...
    @Column(name="language_name", unique=true, length=60)
