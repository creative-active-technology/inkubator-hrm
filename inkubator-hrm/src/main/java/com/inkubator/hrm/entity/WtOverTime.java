...
public class WtOverTime  implements java.io.Serializable {
    ...
    public WtOverTime(long id, String code, String name, String description, Double minimumTime, Double maximumTime, Integer overTimeCalculation, Integer otRounding, Date startTimeFactor, Date finishTimeFactor, Double valuePrice, String createdBy, Date createdOn, String updatedBy, Date updatedOn) {
       this.id = id;
       this.code = code;
       this.name = name;
    ...
    @Column(name="minimum_time", precision=22, scale=0)
    ...
    @Column(name="maximum_time", precision=22, scale=0)
