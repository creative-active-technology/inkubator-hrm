...
public class IpPermit implements java.io.Serializable {
    ...
    public IpPermit(long id, Integer fromAddress1, Integer fromAddress2, Integer fromAddress3, Integer fromAddress4, Integer untilAddress1, Integer untilAddress2, Integer untilAddress3, Integer untilAddress4, String lokasi, String createdBy, Date createdOn, String updatedBy, Date updatedOn) {
        this.id = id;
