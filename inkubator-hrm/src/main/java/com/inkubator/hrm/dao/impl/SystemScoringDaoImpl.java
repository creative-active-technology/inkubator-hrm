 ...
 * @author Deni
 */
@Repository(value = "systemScoringDao")
@Lazy
public class SystemScoringDaoImpl extends IDAOImpl<SystemScoring> implements SystemScoringDao {

    @Override
    public Class<SystemScoring> getEntityClass() {
        return SystemScoring.class;
    }
