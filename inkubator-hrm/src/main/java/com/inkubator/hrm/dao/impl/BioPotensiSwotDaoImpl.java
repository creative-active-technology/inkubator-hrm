 ...
 * @author Deni
 */
@Repository(value = "bioPotensiSwotDao")
@Lazy
public class BioPotensiSwotDaoImpl extends IDAOImpl<BioPotensiSwot> implements BioPotensiSwotDao {

    @Override
    public Class<BioPotensiSwot> getEntityClass() {
        return BioPotensiSwot.class;
    }
