...
function handleLogin(loginHistoryPushMessageModel) {
	...
	PF('socketNotificationGrowl').renderMessage({summary:loginHistoryPushMessageModel.growlTitle, detail: loginHistoryPushMessageModel.growlMessage, severity: 'info'});
